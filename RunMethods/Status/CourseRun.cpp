...
void CourseRun::createCourseL(){
    ...
    // patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 30, 0.4, 0.01, 0.03, 60));
    ...
    patterns.push_back(new RunPattern(LINE_TRACE, 25, COLOR, 8, 0.5, 0.1, 0.03, 80)); // ゲームエリアの黄色　最後の引数 80 70 60
}
...
void CourseRun::createCourseR(){
    ...
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 70, 0.4, 0.02, 0.03, 60, RIGHT)); // GATE2

    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 10, 0.25, 0.03, 0.03, 60, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 30, 0.4, 0.01, 0.03, 60, RIGHT));
