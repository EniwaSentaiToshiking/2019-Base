...
void CourseRun::createCourseR(){
    patterns.push_back(new RunPattern(LINE_TRACE, 50, DISTANCE, 20, 0.7, 0.01, 0.03, 40, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 70, DISTANCE, 50, 0.25, 0.01, 0.03, 60, RIGHT));

    patterns.push_back(new RunPattern(LINE_TRACE, 70, DISTANCE, 70, 0.35, 0.01, 0.04, 60, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 70, DISTANCE, 70, 0.25, 0.01, 0.03, 60, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 70, DISTANCE, 70, 0.35, 0.01, 0.04, 60, RIGHT));

    // s字
    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 70, 0.5, 0.01, 0.03, 60, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 30, 0.5, 0.01, 0.03, 60, RIGHT));

    // GATE1からの円
    patterns.push_back(new RunPattern(LINE_TRACE, 45, DISTANCE, 120, 0.65, 0.03, 0.04, 60, RIGHT)); // 適切な値 ふらつく
    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 20, 0.4, 0.01, 0.03, 60, RIGHT)); // 500

    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 90, 0.5, 0.03, 0.04, 60, RIGHT));

    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 90, 0.25, 0.01, 0.03, 60, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 70, 0.5, 0.01, 0.04, 60, RIGHT)); // GATE2

    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 10, 0.25, 0.01, 0.03, 60, RIGHT));
    patterns.push_back(new RunPattern(LINE_TRACE, 45, DISTANCE, 30, 0.5, 0.03, 0.04, 60, RIGHT));

    patterns.push_back(new RunPattern(LINE_TRACE, 45, DISTANCE, 150, 0.5, 0.02, 0.03, 60, RIGHT)); // 最後の円
    patterns.push_back(new RunPattern(LINE_TRACE, 55, DISTANCE, 30, 0.25, 0.01, 0.03, 40, RIGHT));

    patterns.push_back(new RunPattern(LINE_TRACE, 35, DISTANCE, 20, 0.7, 0.01, 0.03, 40, RIGHT));
}